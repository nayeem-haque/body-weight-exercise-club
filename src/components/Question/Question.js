    ...
    <div className="question-container">
      <div className="answer">
        <h3>
          ...
          <p>
            Answer:  React uses a declarative paradigm that makes it easier to
        ...
        <h3>
          ...
          <p>
             Answer:  The main difference between Props are used to pass data from
        ...
        <h3>
          ...
          <p>
            Answer:  UseEffect is the solution to many problems: how to fetch data
